...
class AnglesToNED(NEDModifier):
    ...
    def modify(self):
        try:
            ...
            self.data['pitch']=tmp
            self.data['yaw']=math.pi/2-self.data['yaw']     
        except KeyError as detail:
            self.key_error(detail)
...
class SFUvelocityToFSD(NEDModifier):
    def modify(self):
        try:
            ...
            tmp=self.data['linear_velocity'][0]
            self.data['linear_velocity'][0]=self.data['linear_velocity'][1]
            self.data['linear_velocity'][1]=tmp
            self.data['linear_velocity'][2]=-self.data['linear_velocity'][2]
