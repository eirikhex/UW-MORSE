...
class Seabotix(Robot):
	...
	def __init__(self, name = None, debug = True,Actuators = False, Sensors=False):
		...
		Robot.__init__(self, 'subseaIMR/robots/Seabotix.blend', name)
		self.properties(classpath = "subseaIMR.robots.Seabotix.Seabotix")
		...
		self.M_a = [[12.68338526,	  -1.406784743,	 -0.1600120366,	  -0.00318564,	 -0.0608072966,	0.209957761],
		...
		self.M_a = [[	12.68338526	,-0.3001816025,	0.0022909139,	-0.0006680495,	-0.0607954368,	0.0287004510*0 ],
					[	-0.3001816025,	23.6526745,	-2.46655344,	0.0542346885,	0.0014514354,	1.1410535955 *0],
					[	0.0022909139,	-2.46655344,	29.956199,	-0.0056521739,	-0.0391101853,	-0.2203375096],
					[	-0.0006680495,	0.0542346885,	-0.0056521739,	0.5431413943,	-0.0032340298,	0.0261588261 ],
					[	-0.0607954368,	0.0014514354,	-0.0391101853,	-0.0032340298,	0.6089980261,	-0.0001377984],
					[	0.028700451*0,	1.1410535955*0,	-0.2203375096,	0.0261588261,	-0.0001377984,	0.4097704000 ]]
		...
		if Actuators:
			...
			self.thrusters.add_parameters(thrust_lim = [30.0, 60.0, 30.0,100,100,60.0*0.05])
		...
		if Sensors:
			...
			camera.properties(cam_width=1280, cam_height=720, cam_focal=10, cam_far=200)
			self.camera = camera
			self.append(camera)
